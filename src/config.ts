...
export const WEAPONS: WeaponSpec[] = [
  ...
  { id: 'rpg', name: 'RPG', melee: false, auto: false, starter: true, damage: 150, cooldown: 0.9, range: 200, magazine: 1, reserve: 4, reloadTime: 3, spread: 0, pellets: 0, projectile: { speed: 62, radius: 7, damage: 150 }, sound: [{ freq: 180, duration: 0.26, volume: 0.18, type: 'sawtooth' }, { freq: 88, duration: 0.36, volume: 0.12, type: 'square' }] },
];
