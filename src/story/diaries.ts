...
export const DIARY_TEXTS: Readonly<Record<number, string>> = {
  ...
  8: 'Drove west past the last mine dumps until the city lights stopped mattering. The old lady at the padstal says the power never trips out here. No paying customers, I told her. She didn\'t laugh.',
  9: 'At the slipway the dam rises and falls on somebody\'s schedule, same as the grid. Except nobody bills the dam. Watched it until dark. The dark came from the city side.',
  ...
  12: 'The yard off Wemmer Jubilee has floodlights like a border post and a generator that has never once run. I stood at the fence and understood everything. Tomorrow I take it all to the lawyer.',
};
