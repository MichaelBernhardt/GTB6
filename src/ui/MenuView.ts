...
export class MenuView {
  ...
  controls(fromMain: boolean, back: () => void): void {
    const groups = [
      ['WASD', 'Move / drive'], ['MOUSE', 'Look / aim'], ['SHIFT', 'Sprint'], ['CTRL/RMB', 'Aim / drive-by'], ['SPACE', 'Jump / handbrake'], ['E', 'Interact / vehicle'], ['Q', 'Take cover'], ['LMB', 'Fire / punch'], ['TAB', 'Weapon wheel'], ['SCROLL', 'Cycle weapons'], ['1—5', 'Select weapon'], ['R', 'Reload'], ['V', 'Camera view'], ['F', 'Mug / melee / recover'], ['G', 'Siren (police car)'], ['PGUP/PGDN', 'Minimap zoom'], ['ESC', 'Pause'], ['~', 'Console'],
    ];
