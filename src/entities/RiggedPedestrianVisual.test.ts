...
const state = (overrides: Partial<RiggedPedestrianState> = {}): RiggedPedestrianState => ({
  state: 'idle', dead: false, knockdown: false, punching: false, punchElapsed: 0, braced: false, hailing: false, covering: false, aiming: false, stumbling: false, stumbleAmount: 0, ...overrides,
});
