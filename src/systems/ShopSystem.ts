...
export const SHOPS: ShopPlace[] = [
  { kind: 'weapons', name: 'Cordova Arms', pad: new THREE.Vector3(12, 0, 220), radius: 3.6, driveIn: false },
  { kind: 'spray', name: 'Palm Spray', pad: new THREE.Vector3(236, 0, 60), radius: 5, driveIn: true },
  { kind: 'garage', name: 'Avenida Garage', pad: new THREE.Vector3(-38, 0, 272), radius: 5, driveIn: true },
  { kind: 'hotdog', name: 'Sizzlin’ Dogs', pad: new THREE.Vector3(25.5, 0, 77), radius: 3.2, driveIn: false },
];
...
export class ShopSystem {
  ...
  private buildGarage(city: City): void {
    const x = -46; const z = 272; // open door faces +x toward Avenida Cordova and the spawn
