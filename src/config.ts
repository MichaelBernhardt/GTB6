...
export const VEHICLE_SPECS: Record<VehicleKind, VehicleSpec> = {
  ...
  superbike: { kind: 'superbike', name: 'Sandton Rocket', color: 0x84f01c, maxSpeed: 60, acceleration: 46, brake: 46, steering: 3.1, drag: 0.5, health: 55, size: [0.78, 1.05, 2.2], twoWheeler: true, saddle: [0.03, -0.03] },
};
